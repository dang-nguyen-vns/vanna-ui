...
export let suggestedQuestions = null;
export let messageLog = [];
export let newQuestion;
export let rerunSql;
export let clearMessages;
export let onUpdateSql;
export let question_asked;
export let marked_correct;
export let thinking;
let inputValue = "";
let pendingQuestion = null;
let previousLength = 0;
function saveToHistory(question, log) {
...
onMount(() => {
  ...
  if (historyStr) {
    ...
    const ordered = Object.entries(history).sort(
